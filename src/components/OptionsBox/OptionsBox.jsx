  ...
  return (
    <>
      <div className='options-box' >
        ...
        <a rel="nofollow" href='#' className='options-item'>
          <span className='options-text'>Hoteles</span>
          <span className='options-svg'>
        ...
        <a rel="nofollow" href='#' className='options-item'>
          <span className='options-text'>Alquileres vacacionales</span>
          <span className='options-svg'>
        ...
        <a rel="nofollow" href='#' className='options-item'>
          <span className='options-text'>Cosas que hacer</span>
          <span className='options-svg'>
        ...
        <a rel="nofollow" href='#' className='options-item'>
          <span className='options-text'>Restaurantes</span>
          <span className='options-svg'>
        ...
        <a rel="nofollow" href='#' className='options-item'>
          <span className='options-text'>Foros de viajes</span>
          <span className='options-svg'>
        ...
        <a rel="nofollow" href='#' className='options-item'>
          <span className='options-text'>Vuelos</span>
          <span className='options-svg'>
        ...
        <a rel="nofollow" href='#' className='options-item'>
          <span className='options-text'>Cruceros</span>
          <span className='options-svg'>
        ...
        <a rel="nofollow" href='#' className='options-item'>
          <span className='options-text'>Más</span>
          <span className='options-svg'>
